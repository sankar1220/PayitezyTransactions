...
@Relation(value = "rechargeTransactionResource", collectionRelation = "rechareTransactionResource")
public class RechargeTransactionResource extends ResourceWithEmbeddeds {
    ...
    /**
     * @return the rechargeTransactionId
     */
    ...
    /**
     * @param rechargeTransactionId the rechargeTransactionId to set
     */
